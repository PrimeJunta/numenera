define({
    ...
    "D4" : {
        ...
        "lists" : {
            "ability_list" : [ "Ⓣ Perceiving (fugue)",
                               "Ⓣ Attacks with chosen weapon (bursk)",
                               "Ⓣ Breaking things (bursk)",
                               "Ⓣ Perceiving (bursk)",
    ...
    "D6" : {
        ...
        "lists" : {
            "bonus_list" : [ "${select:1:!topic:CharGen/MutationTypeSelected|Ⓜ 2 beneficial mutations|Ⓜ 1 harmful + 3 beneficial mutations|Ⓜ 1 harmful + 1 powerful mutation|Ⓜ harmful + 1 distinctive mutation}",
